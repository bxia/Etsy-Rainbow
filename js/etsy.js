    ...
    var loadId = setInterval(function() {
        if(i===allGrids.length){
            ...
            var id = setInterval(function () {
                if(readFromCache(filter) !== undefined){
                    clearInterval(id);
                    result = findMostPopular(readFromCache(filter),filter);
                    ...
                    if(result === undefined){
                        ...
                        allGrids[i].el.html(
                                    "<img src='"+ result.Images[0].url_75x75 +"'/>");
                        console.log("done");
                    }
        ...
        // filter.color = hsv[0]+","+hsv[1]+","+hsv[2] ;
        // sendRequest(prepareURL(filter),process);
        // var id = setInterval(function () {
        // if(readFromCache(filter) !== undefined){
        //     clearInterval(id);
        ...
        //     console.log(findMostPopular(readFromCache(filter),filter));
        //     result = findMostPopular(readFromCache(filter),filter)
        //     var src = result.Images[0].url_75x75;
        //     console.log(src);

        //     console.log(element.html("<img id='theImg' src='"+src +"'/>"));
        //     //$(this).append("<img id='theImg' src='"+src +"'/>");
